...
def load_model():
    ...
    global model
    try:
        # Try to load a simple model first for testing
        # If you have a custom model, replace this with your loading logic
        ...
        print("✅ Model created successfully (using test model)")
        return True
